...
import { Alert, Button, Group, Rating, SegmentedControl, Space, Stack, Text, Textarea, Title } from '@mantine/core';
		...
		<PaperErrorBoundary paperId={paper.paper_id}>
			...
			{showClassicMarkScheme ? (
				<Group justify='center' mb='sm'>
					<Button variant='light' size='sm' onClick={() => setMarkSchemeModalOpen(true)}>
						Mark scheme hints
					</Button>
				</Group>
			) : null}
			{paperMode === 'study' && markScheme?.status === 'pending' ? (
				<Alert variant='light' color='blue' mb='sm' ta='center'>
