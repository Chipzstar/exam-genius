...
export const env = createEnv({
	...
	server: {
		...
		WJEC_BIOLOGY_COURSE_PRICE_ID: z.string().min(1),
		WJEC_CHEMISTRY_COURSE_PRICE_ID: z.string().min(1),
		WJEC_ECONOMICS_COURSE_PRICE_ID: z.string().min(1),
		WJEC_MATHS_COURSE_PRICE_ID: z.string().min(1),
		WJEC_PHYSICS_COURSE_PRICE_ID: z.string().min(1),
		WJEC_PSYCHOLOGY_COURSE_PRICE_ID: z.string().min(1),
	...
	runtimeEnv: {
		...
		WJEC_BIOLOGY_COURSE_PRICE_ID: process.env.WJEC_BIOLOGY_COURSE_PRICE_ID,
		WJEC_CHEMISTRY_COURSE_PRICE_ID: process.env.WJEC_CHEMISTRY_COURSE_PRICE_ID,
		WJEC_ECONOMICS_COURSE_PRICE_ID: process.env.WJEC_ECONOMICS_COURSE_PRICE_ID,
		WJEC_MATHS_COURSE_PRICE_ID: process.env.WJEC_MATHS_COURSE_PRICE_ID,
		WJEC_PHYSICS_COURSE_PRICE_ID: process.env.WJEC_PHYSICS_COURSE_PRICE_ID,
		WJEC_PSYCHOLOGY_COURSE_PRICE_ID: process.env.WJEC_PSYCHOLOGY_COURSE_PRICE_ID,
