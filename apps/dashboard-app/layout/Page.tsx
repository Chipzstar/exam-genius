...
const Container = ({ children, header = undefined, classNames = 'h-screen flex flex-col', extraClassNames="", data_cy=undefined }: PageContainerProps) => {
  return (
...
const Header = ({ children, classNames = 'bg-white mb-4 flex items-center px-6', extraClassNames="", height = DEFAULT_HEADER_HEIGHT }) => {
  return (
    <div
